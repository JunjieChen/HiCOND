...
def gen_write_g_stmt(fout):
    ...
    map_stmt['statement_assign_prob='] = 100.0 / 9.0 * 1.0
    map_stmt['statement_block_prob='] = 100.0 / 9.0 * 2.0
    map_stmt['statement_for_prob='] = 100.0 / 9.0 * 3.0
    map_stmt['statement_ifelse_prob='] = 100.0 / 9.0 * 4.0
    map_stmt['statement_return_prob='] = 100.0 / 9.0 * 5.0
    map_stmt['statement_continue_prob='] = 100.0 / 9.0 * 6.0
    map_stmt['statement_break_prob='] = 100.0 / 9.0 * 7.0
    map_stmt['statement_goto_prob='] = 100.0 / 9.0 * 8.0
    map_stmt['statement_arrayop_prob='] = 100
...
def gen_write_g_unary(fout):
    ...
    map_unary['unary_plus_prob='] = 25
    map_unary['unary_minus_prob='] = 50
    map_unary['unary_not_prob='] = 75
    map_unary['unary_bit_not_prob='] = 100
...
def gen_write_g_binary(fout):
    ...
    map_binary['binary_add_prob='] = 100.0 / 18.0 * 1.0
    map_binary['binary_sub_prob='] = 100.0 / 18.0 * 2.0
    map_binary['binary_mul_prob='] = 100.0 / 18.0 * 3.0
    map_binary['binary_div_prob='] = 100.0 / 18.0 * 4.0
    map_binary['binary_mod_prob='] = 100.0 / 18.0 * 5.0
    map_binary['binary_gt_prob='] = 100.0 / 18.0 * 6.0
    map_binary['binary_lt_prob='] = 100.0 / 18.0 * 7.0
    map_binary['binary_ge_prob='] = 100.0 / 18.0 * 8.0
    map_binary['binary_le_prob='] = 100.0 / 18.0 * 9.0
    map_binary['binary_eq_prob='] = 100.0 / 18.0 * 10.0
    map_binary['binary_ne_prob='] = 100.0 / 18.0 * 11.0
    map_binary['binary_and_prob='] = 100.0 / 18.0 * 12.0
    map_binary['binary_or_prob='] = 100.0 / 18.0 * 13.0
    map_binary['binary_bit_xor_prob='] = 100.0 / 18.0 * 14.0
    map_binary['binary_bit_and_prob='] = 100.0 / 18.0 * 15.0
    map_binary['binary_bit_or_prob='] = 100.0 / 18.0 * 16.0
    map_binary['binary_bit_rshift_prob='] = 100.0 / 18.0 * 17.0
    map_binary['binary_bit_lshift_prob='] = 100
...
def gen_write_g_simplet(fout):
    ...
    map_simplet['char_prob='] = 100.0 / 11.0 * 1.0
    map_simplet['int_prob='] = 100.0 / 11.0 * 2.0
    map_simplet['short_prob='] = 100.0 / 11.0 * 3.0
    map_simplet['long_prob='] = 100.0 / 11.0 * 4.0
    map_simplet['long_long_prob='] = 100.0 / 11.0 * 5.0
    map_simplet['uchar_prob='] = 100.0 / 11.0 * 6.0
    map_simplet['uint_prob='] = 100.0 / 11.0 * 7.0
    map_simplet['ushort_prob='] = 100.0 / 11.0 * 8.0
    map_simplet['ulong_prob='] = 100.0 / 11.0 * 9.0
    map_simplet['ulong_long_prob='] = 100.0 / 11.0 * 10.0
    map_simplet['float_prob='] = 100
...
def gen_write_g_safeop(fout):
    ...
    map_safeop['safe_ops_size_int8='] = 25
    map_safeop['safe_ops_size_int16='] = 50
    map_safeop['safe_ops_size_int32='] = 75
    map_safeop['safe_ops_size_int64='] = 100
